<?php
  $expoEmail = get_option('expo-email');
  $expoPhone = get_option('expo-phone');
?>
  ...
  <div class="sectionBlk">
    <div class="container clearfix">
      <div class="des-column col_12 txtCenter">
        ...
        <h5 class="colorGREY mb40">
          Complete the form below or contact us at <a class="typLink" href="tel:<?php echo $expoPhone ?>" target="_blank" rel="nofollow"><?php echo $expoPhone ?></a> | <a class="typLink" href="mailto:<?php echo $expoEmail ?>" target="_blank" rel="nofollow"><?php echo $expoEmail ?></a>
        </h5>
