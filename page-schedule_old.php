        ...
        <ul>
          <?php if ($query->have_posts()) : ?>
            <?php while ($query->have_posts()) : $query->the_post(); ?>
              <?php
                $start = get_post_meta($post->ID, 'schedule-time-start', true);
                $end = get_post_meta($post->ID, 'schedule-time-end', true);
               ?>
              <li>
